...
SERVER_URL = "http://localhost:8080/sales-server/rest";
...
$app.config(['$routeProvider', '$httpProvider', function ($routeProvider, $httpProvider) {
	...
	when('/produtos', {
		templateUrl: 'view/produtos/main.html',
		controller: 'produtosController'
	}).
	when('/produtos/new', {
		templateUrl: 'view/produtos/update.html',
		controller: 'produtosController'
	}).
	when('/produtos/:id', {
		templateUrl: 'view/produtos/update.html',
	...
	when('/categorias', {
		templateUrl: 'view/categorias/main.html',
		controller: 'categoriasController'
	}).
	when('/categorias/new', {
		templateUrl: 'view/categorias/update.html',
		controller: 'categoriasController'
	}).
	when('/categorias/:id', {
			templateUrl: 'view/categorias/update.html',
